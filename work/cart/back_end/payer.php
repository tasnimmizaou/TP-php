...
<head>
    ...
    <style>
        ...
        .payment-option {
            text-align: center;
            margin-bottom: 20px; /* Marge entre les options */
        }
...
<body>
    <h1>Choix du Mode de Paiement</h1>
    ...
    <script>
        function selectPayment(paymentMethod) {
            // Vous pouvez effectuer des actions basées sur le mode de paiement sélectionné ici
